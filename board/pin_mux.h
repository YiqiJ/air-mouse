...
#define BOARD_LED_RED_GPIO_PIN 22U    /*!<@brief PORTB pin index: 17 */

#define BOARD_LED_GREEN_PORT PORTE /*!<@brief PORT device name: PORTB */
#define BOARD_LED_GREEN_GPIO_PIN 26U    /*!<@brief PORTB pin index: 17 */

#define BOARD_LED_BLUE_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_LED_BLUE_GPIO_PIN 21U    /*!<@brief PORTB pin index: 17 */
                                       /* @} */

#define BOARD_SW3_PORT PORTA /*!<@brief PORT device name: PORTB */
#define BOARD_SW3_GPIO_PIN 4U    /*!<@brief PORTB pin index: 17 */
                                       /* @} */

#define BOARD_SW2_PORT PORTC /*!<@brief PORT device name: PORTB */
#define BOARD_SW2_GPIO_PIN 6U    /*!<@brief PORTB pin index: 17 */
