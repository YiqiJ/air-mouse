...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinConfig(BOARD_SW3_PORT, BOARD_SW3_GPIO_PIN, &porta4_pin38_config);  /* PORTA4 (pin 38) is configured as Button */
    PORT_SetPinConfig(BOARD_SW2_PORT, BOARD_SW2_GPIO_PIN, &porta4_pin38_config);  /* PORTA4 (pin 38) is configured as Button */
    ...
    /* PORTB22 is configured as GPIO (LED) */
	PORT_SetPinMux(BOARD_LED_RED_PORT, BOARD_LED_RED_GPIO_PIN, kPORT_MuxAsGpio);
	PORT_SetPinMux(BOARD_LED_GREEN_PORT, BOARD_LED_GREEN_GPIO_PIN, kPORT_MuxAsGpio);
