...
/*
 * Standard request callback function typedef.
 *
 * This function is used to handle the standard request.
 *
 * [handle]          The device handle. It equals the value returned from USB_DeviceInit.
 * [setup]           The pointer of the setup packet.
 * [buffer]          It is an out parameter, is used to save the buffer address to response the host's request.
 * [length]          It is an out parameter, the data length.
 *
...
/*
 * Get the setup packet buffer.
 *
 * The function is used to get the setup packet buffer to save the setup packet data.
 *
 * handle              The device handle.
 * setupBuffer        It is an OUT parameter, return the setup buffer address to the caller.
 *
 ...
 *
 * [handle]              The device handle.
 * [setup]               The setup packet buffer address.
 * [length]              It is an OUT parameter, return the data length need to be sent to host.
 * [buffer]              It is an OUT parameter, return the data buffer address.
 *
 * RETURN A USB error code or kStatus_USB_Success.
 */
...
/*
 * Get the buffer to save the class specific data sent from host.
 *
 ...
 * [handle]              The device handle.
 * [setup]               The setup packet buffer address.
 * [length]              Pass the length the host needs to sent.
 * [buffer]              It is an OUT parameter, return the data buffer address to save the host's data.
 *
 * RETURN A USB error code or kStatus_USB_Success.
 */
 ...
 *
 * [handle]              The device handle.
 * [configure]           The configuration value.
 *
 * RETURN A USB error code or kStatus_USB_Success.
 */
 ...
 *
 * [handle]              The device handle.
 * [configure]           It is an OUT parameter, save the current configuration value.
 *
 * RETURN A USB error code or kStatus_USB_Success.
 */
 ...
 * [alternateSetting]   The new alternate setting value.
 *
 * RETURN A USB error code or kStatus_USB_Success.
 */
...
/*
 * Get an interface alternate setting.
 *
 * The function is used to get an interface alternate setting.
 *
 * [handle]              The device handle.
 * [interface]           The interface index.
 * [alternateSetting]   It is an OUT parameter, save the new alternate setting value of the interface.
 *
 * RETURN A USB error code or kStatus_USB_Success.
 */
...
/*
 * Configure a specified endpoint status.
 *
 * The function is used to configure a specified endpoint status, idle or halt.
 *
 * [handle]              The device handle.
 * [endpointAddress]    The endpoint address, the BIT7 is the direction, 0U - USB_OUT, 1U - USB_IN.
 * [status]              The new status of the endpoint, 0U - idle, 1U - halt.
 *
 * RETURN A USB error code or kStatus_USB_Success.
 */
...
/*
 * Configure the device remote wakeup feature.
 *
 * The function is used to configure the device remote wakeup feature, enable or disbale the remote wakeup feature.
 *
 * [handle]              The device handle.
 * [enable]              The new feature value of the device remote wakeup, 0U - disable, 1U - enable.
 *
 * RETURN A USB error code or kStatus_USB_Success.
 */
 ...
 * [length]          It is an out parameter, the data length.
 *
 * RETURN kStatus_USB_Success              The request is handled successfully.
 * RETURN kStatus_USB_InvalidRequest       The request can not be handle in current device state,
...
/*
 * Handle set or clear device feature request.
 *
...
/*
 * Handle get current configuration request.
 *
...
/*
 * Handle get the alternate setting of a interface request.
 *
 ...
 * [handle]          The device handle. It equals the value returned from USB_DeviceInit.
 * [setup]           The pointer of the setup packet.
 * [error]           The error code returned from the standard request function.
 * [stage]           The stage of the control transfer.
 * [buffer]          It is an out parameter, is used to save the buffer address to response the host's request.
 * [length]          It is an out parameter, the data length.
 *
 * RETURN A USB error code or kStatus_USB_Success.
